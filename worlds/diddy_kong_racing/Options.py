...
class DoorRequirementDistribution(Choice):
    """
    The distribution of door requirement amounts:
    ...
    """
    display_name = "Door requirement distribution"
    option_vanilla = 0
    option_linear = 1
...
class MaximumDoorRequirement(Range):
    """Maximum balloon requirement for a numbered door (does not include the Wizpig 2 door). Only used if door requirement distribution is not vanilla."""
...
class DiddyKongRacingOptions(PerGameCommonOptions):
    ...
    door_requirement_distribution: DoorRequirementDistribution
