...
class DiddyKongRacingRules:
    ...
    def balloon_snowball_valley_2(self, state: CollectionState) -> bool:
        return (self.total_balloon_count(state) >= 14
                and state.has(ItemName.SNOWFLAKE_MOUNTAIN_BALLOON, self.player, 4))

    def balloon_frosty_village_1(self, state: CollectionState) -> bool:
        return self.total_balloon_count(state) >= 9
    ...
    def balloon_whale_bay_2(self, state: CollectionState) -> bool:
        return (self.total_balloon_count(state) >= 17
                and state.has(ItemName.SHERBET_ISLAND_BALLOON, self.player, 4))
    ...
    def balloon_pirate_lagoon_1(self, state: CollectionState) -> bool:
        return self.total_balloon_count(state) >= 13

    def balloon_pirate_lagoon_2(self, state: CollectionState) -> bool:
        return (self.total_balloon_count(state) >= 20
                and state.has(ItemName.SHERBET_ISLAND_BALLOON, self.player, 4))
    ...
    def balloon_treasure_caves_2(self, state: CollectionState) -> bool:
        return (self.total_balloon_count(state) >= 22
                and state.has(ItemName.SHERBET_ISLAND_BALLOON, self.player, 4))
    ...
    def balloon_windmill_plains_2(self, state: CollectionState) -> bool:
        return (self.total_balloon_count(state) >= 23
                and state.has(ItemName.DRAGON_FOREST_BALLOON, self.player, 4))
    ...
    def balloon_greenwood_village_2(self, state: CollectionState) -> bool:
        return (self.total_balloon_count(state) >= 24
                and state.has(ItemName.DRAGON_FOREST_BALLOON, self.player, 4))
    ...
    def balloon_boulder_canyon_2(self, state: CollectionState) -> bool:
        return (self.total_balloon_count(state) >= 30
                and state.has(ItemName.DRAGON_FOREST_BALLOON, self.player, 4))
    ...
    def tricky_2(self, state: CollectionState) -> bool:
        return state.has(ItemName.DINO_DOMAIN_BALLOON, self.player, 8)

    def bluey_2(self, state: CollectionState) -> bool:
        return state.has(ItemName.SNOWFLAKE_MOUNTAIN_BALLOON, self.player, 8)

    def bubbler_2(self, state: CollectionState) -> bool:
        return state.has(ItemName.SHERBET_ISLAND_BALLOON, self.player, 8)

    def smokey_2(self, state: CollectionState) -> bool:
        return state.has(ItemName.DRAGON_FOREST_BALLOON, self.player, 8)
    ...
    def wizpig_2(self, state: CollectionState) -> bool:
        return state.has(ItemName.TT_AMULET_PIECE, self.player, 4) and self.total_balloon_count(state) >= 47

    def total_balloon_count(self, state: CollectionState) -> int:
        return (state.count(ItemName.TIMBERS_ISLAND_BALLOON, self.player) 
